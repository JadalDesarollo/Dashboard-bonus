...
const generateAndDownloadPDFbyClient = async (dataFilter: any) => {
  try {
    console.log(dataFilter)
    const token = localStorage.getItem("token") || "";
    const response = await fetch(
      `${process.env.REACT_APP_BASE_URL}/generar-pdf-cliente`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const descargarPDFbyClient = async (response: Response) => {
  try {
    const fileName = `${format(
      new Date(),
      "dd_MM_yyyy"
...
const generateAndDownloadEXCELByClient = async (dataFilter: any) => {
  try {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_BASE_URL}/generar-excel-cliente`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export default {
  ...
  generateAndDownloadEXCELByClient,
  generateAndDownloadPDFbyClient,
};
